module github.com/LumeraProtocol/interchaintest_test
...
require (
	...
	cosmossdk.io/client/v2 v2.0.0-beta.8.0.20250402172810-41e3e9d004a1 // indirect
...
// Required replace directives for interchaintest dependencies
replace (
	// Fix for go-schnorrkel invalid version error
	github.com/ChainSafe/go-schnorrkel => github.com/ChainSafe/go-schnorrkel v0.0.0-20200405005733-88cbf1b4c40d
	github.com/ChainSafe/go-schnorrkel/1 => github.com/ChainSafe/go-schnorrkel v1.0.0
	// Additional recommended replacements from interchaintest
	github.com/btcsuite/btcd/btcec/v2 => github.com/btcsuite/btcd/btcec/v2 v2.3.3

	github.com/docker/distribution => github.com/docker/distribution v2.8.2+incompatible
	// Pin Docker to v25 for API v1.44+ compatibility (v26+ moves Container*Options out of types)
	github.com/docker/docker => github.com/docker/docker v25.0.6+incompatible
	// Fix for gogo/protobuf v1.3.3 missing revision error
